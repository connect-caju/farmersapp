        ...
        <Stack direction="row" w="100%">
          <Box>
            <TouchableOpacity onPress={() => navigation.goBack()}>
              <Icon name="arrow-back-ios" size={wp("8%")} color={COLORS.main} />
            </TouchableOpacity>
          </Box>
          <Box w="70%">
            <TouchableOpacity
              ...
              {pendingFarmers &&
                filteredResources(farmersList, "pendingFarmers").length ===
                  ...
                  >
                    ...
                    >
                      Nenhum registo de produtor aguarda validação !
                    </Text>
                    <Text
                      style={{
                        fontSize: 14,
              ...
              {invalidatedFarmers &&
                filteredResources(farmersList, "invalidatedFarmers").length ===
                  ...
                  >
                    ...
                    >
                      Nenhum registo de produtor encontra-se invalidado !
                    </Text>
                    <Text
                      style={{
                        fontSize: 14,
              ...
              {invalidatedFarmlands &&
                filteredResources(farmlandList, "invalidatedFarmlands")
                  ...
                  >
                    ...
                    >
                      Nenhum registo de pomar encontra-se invalidado !
                    </Text>
                    <Text
                      style={{
                        fontSize: 14,
              ...
              {pendingFarmlands &&
                filteredResources(farmlandList, "pendingFarmlands").length ===
                  ...
                  >
                    ...
                    >
                      Nenhum registo de pomar aguarda validação !
                    </Text>
                    <Text
                      style={{
                        fontSize: 14,
