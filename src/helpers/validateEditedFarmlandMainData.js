...
const validateEditedFarmlandMainData = (
  ...
  if (dataToBeUpdated === "farmlandMainData" && resourceName == "Farmland") {
    ...
    const retrievedConsociatedCrops =
      consociatedCrops?.length > 0 ? consociatedCrops : []
    ...
    const retrievedOldConsociatedCrops =
      oldConsociatedCrops?.length > 0 ? oldConsociatedCrops : []
    ...
    if (
      ...
      setErrors({
        ...
        consociatedCrops:
          "As culturas consociadas actuais não podem ser iguais às anteriores.",
    ...
    if (
      ...
      setErrors({
        ...errors,
        areaInconsistencies:
          "A área total é inferior à soma das áreas dos blocos.",
        treesInconsistencies:
          "O número total de cajueiros é inferior à soma dos cajueiros dos blocos.",
      })
      return false
    }
    ...
    if (
      ...
      setErrors({
        ...errors,
        treesInconsistencies:
          "O número total de cajueiros não deve ser inferior à soma dos cajueiros dos blocos.",
      })
      return false
    }
    ...
    if (
      ...
      setErrors({
        ...errors,
        areaInconsistencies:
          "A área total não deve ser inferior à soma das áreas dos blocos.",
      })
      return false
    }
