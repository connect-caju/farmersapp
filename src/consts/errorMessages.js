export const errorMessages = {
  ...
  blockTreesConformityError: {
    ...
    confirmText: "  Sim  ",
    invalidationMessage:
      "Connect Caju detectou que este pomar tem parcelas de cajueiros que não foram registadas e incentiva o usuário a completar o registo, adicionando mais parcelas com cajueiros.",
    onCancelPressed: () => {},
    onConfirmPressed: () => {},
  },
  ...
  farmlandWithNoBlockError: {
    ...
    confirmText: "  Sim  ",
    invalidationMessage:
      "Connect Caju detectou que este pomar possui dados incompletos e incetiva o usuário a completar o registo, adicionando dados sobre as parcelas deste pomar.",
    onCancelPressed: () => {},
    onConfirmPressed: () => {},
  },
  ...
  blockAreaConformityError: {
    ...
    confirmText: "  Sim  ",
    invalidationMessage:
      "Connect Caju detectou que a área total deste pomar é inferior à soma das áreas das parcelas e incentiva o usuário a corrigir os dados, rectificando a área por parcela com cajueiros.",
    onCancelPressed: () => {},
    onConfirmPressed: () => {},
  },
  ...
  resourceValidation: {
    ...
    message:
      "Após a validação, não será possível alterar dados associados a este registo. Pretendes validar este registo?",
  ...
  resourceInvalidation: {
    ...
    message:
      "Após a invalidação, o usuário irá alterar dados deste registo para uma revalidação a posterior. Pretendes invalidar o registo?",
