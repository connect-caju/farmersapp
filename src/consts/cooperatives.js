export const cooperatives = {
  ...
  Meconta: ["AMPCM", "Cooperativa União Faz A Força"],
  Mecubúri: ["AMPCM"],
  Memba: ["AMPCM"],
  Mogincual: ["AMPCM"],
  Mogovolas: [
  ...
  Nacala: ["AMPCM"],
  "Nacala-a-Velha": ["AMPCM"],
  Nacarôa: ["AMPCM"],
  Nampula: ["AMPCM"],

  Rapale: ["AMPCM", "Cooperativa Agrária de Namaita"],
  Ribaué: [
    "AMPCM",
